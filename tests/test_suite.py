...
class TestSuite(object):
    ...
    def test_iterate_over_director_tree(self):
        ...
        expected_result = [{'lines': 0, 'file_path': 'githubscrapper/tests/__init__.py', 'extension': 'py', 'bytes': 0.0, 'file_name': '__init__.py'}, {'lines': 155, 'file_path': 'githubscrapper/tests/test_suite.py', 'extension': 'py', 'bytes': 7870.0, 'file_name': 'test_suite.py'}, {'lines': 96, 'file_path': 'githubscrapper/.gitignore', 'extension': 'gitignore', 'bytes': 1100.0, 'file_name': '.gitignore'}, {'lines': 31, 'file_path': 'githubscrapper/README.md', 'extension': 'md', 'bytes': 1750.0, 'file_name': 'README.md'}, {'lines': 83, 'file_path': 'githubscrapper/githubscrapper.txt', 'extension': 'txt', 'bytes': 1700.0, 'file_name': 'githubscrapper.txt'}, {'lines': 14, 'file_path': 'githubscrapper/requirements.txt', 'extension': 'txt', 'bytes': 203.0, 'file_name': 'requirements.txt'}, {'lines': 214, 'file_path': 'githubscrapper/webscrapperdirectorytree.py', 'extension': 'py', 'bytes': 7900.0, 'file_name': 'webscrapperdirectorytree.py'}, {'lines': 229, 'file_path': 'githubscrapper/webscrapperfiledetails.py', 'extension': 'py', 'bytes': 8190.0, 'file_name': 'webscrapperfiledetails.py'}]
